import data_download_librairies_metals as data_lib
import pickle

CACHE_PATH = "data_download_gold.pkl"  # the file used as cache
...
if __name__ == "__main__":
    ...
    data_download_global = data_lib.download_all_data("1965-01-01", "2026-05-01")
